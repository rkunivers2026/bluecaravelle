...
export function buildSeed() {
  ...
  const data = {
    ...
    dishes: [
      { id: uid("pl"), nom: "Poisson braisé au feu de bois", categorie: "Spécialité", prix: 18000, description: "Servi avec attiéké ou riz blanc, sauce vierge", image: "assets/poisson_braise.png" },
      { id: uid("pl"), nom: "Soupe de poissons façon Caravelle", categorie: "Spécialité", prix: 16000, description: "La recette signature de la maison, rouille et croûtons", image: "" },
      { id: uid("pl"), nom: "Langouste grillée à l'ail", categorie: "Spécialité", prix: 35000, description: "Beurre d'ail, citron vert, légumes de saison", image: "" },
      { id: uid("pl"), nom: "Assiette de fruits de mer", categorie: "Spécialité", prix: 25000, description: "Pour 1 personne — sélection du jour de la criée", image: "assets/assiette_fruits_mer.png" },
      { id: uid("pl"), nom: "Salade de chèvre chaud", categorie: "Entrée", prix: 7000, description: "Mesclun, noix, miel et vinaigre balsamique", image: "assets/salade_chevre_chaud.png" },
      { id: uid("pl"), nom: "Carpaccio de poisson", categorie: "Entrée", prix: 8000, description: "Poisson de ligne, agrumes, huile d'olive", image: "assets/carpaccio_poisson.png" },
      { id: uid("pl"), nom: "Tartare de thon", categorie: "Entrée", prix: 9000, description: "Thon frais, avocat, sésame et citron vert", image: "" },
      { id: uid("pl"), nom: "Soupe de légumes maison", categorie: "Entrée", prix: 5000, description: "Légumes du marché, crème légère", image: "assets/soupe_legumes.png" },
      { id: uid("pl"), nom: "Acras de morue", categorie: "Entrée", prix: 6000, description: "Beignets croustillants, sauce épicée", image: "assets/acras_morue.png" },
      { id: uid("pl"), nom: "Thiéboudienne Royale", categorie: "Plat", prix: 18000, description: "Poisson, riz et légumes mijotés", image: "" },
      { id: uid("pl"), nom: "Yassa poulet", categorie: "Plat", prix: 15000, description: "Poulet mariné, oignons confits, citron", image: "" },
      { id: uid("pl"), nom: "Mafé de bœuf", categorie: "Plat", prix: 16000, description: "Mijoté à la pâte d'arachide", image: "" },
      { id: uid("pl"), nom: "Risotto aux fruits de mer", categorie: "Plat", prix: 18000, description: "Crémeux, crevettes, moules et parmesan", image: "assets/risotto_fruits_mer.png" },
      { id: uid("pl"), nom: "Pâtes aux crevettes, sauce crémeuse", categorie: "Plat", prix: 15000, description: "Tagliatelles, crevettes, crème et herbes", image: "assets/pates_crevettes.png" },
      { id: uid("pl"), nom: "Brochettes de bœuf", categorie: "Grillade", prix: 16000, description: "Bœuf mariné, légumes grillés", image: "assets/brochettes_boeuf.png" },
      { id: uid("pl"), nom: "Brochettes de poulet", categorie: "Grillade", prix: 14000, description: "Poulet mariné aux épices", image: "assets/brochettes_poulet.png" },
      { id: uid("pl"), nom: "Côtes d'agneau", categorie: "Grillade", prix: 20000, description: "Grillées au feu de bois, herbes fraîches", image: "assets/cotes_agneau.png" },
      { id: uid("pl"), nom: "Poisson entier grillé", categorie: "Grillade", prix: 18000, description: "Pêche du jour, sauce vierge", image: "assets/poisson_entier_grille.png" },
      { id: uid("pl"), nom: "Mix grill", categorie: "Grillade", prix: 35000, description: "Pour 2 personnes — bœuf, poulet, agneau, poisson", image: "assets/mix_grill.png" },
      { id: uid("pl"), nom: "Accompagnements", categorie: "Accompagnement", prix: 3000, description: "Attiéké · Riz blanc · Frites maison · Légumes sautés · Alloco — chacun", image: "assets/accompagnements.png" },
      { id: uid("pl"), nom: "Fondant au chocolat", categorie: "Dessert", prix: 5000, description: "Cœur coulant, glace vanille", image: "" },
      { id: uid("pl"), nom: "Douceur coco ananas", categorie: "Dessert", prix: 5000, description: "Mousse coco et ananas rôti", image: "" },
      { id: uid("pl"), nom: "Salade de fruits frais", categorie: "Dessert", prix: 4000, description: "Fruits de saison, feuilles de menthe", image: "assets/salade_fruits.png" },
      { id: uid("pl"), nom: "Crème brûlée à la vanille", categorie: "Dessert", prix: 5000, description: "Vanille de Madagascar, caramel croquant", image: "" },
      { id: uid("pl"), nom: "Glace artisanale", categorie: "Dessert", prix: 4000, description: "Parfums au choix", image: "" },
      { id: uid("pl"), nom: "Jus naturels", categorie: "Boisson", prix: 3000, description: "Bissap, gingembre, ananas ou mangue", image: "" },
      { id: uid("pl"), nom: "Cocktails maison", categorie: "Boisson", prix: 5000, description: "Les créations du barman", image: "assets/cocktails_maison.png" },
      { id: uid("pl"), nom: "Vins", categorie: "Boisson", prix: 8000, description: "Sélection au verre", image: "" },
      { id: uid("pl"), nom: "Bières", categorie: "Boisson", prix: 3000, description: "Locales & import", image: "" },
      { id: uid("pl"), nom: "Eaux minérales", categorie: "Boisson", prix: 2000, description: "Plate ou pétillante", image: "" }
    ],
